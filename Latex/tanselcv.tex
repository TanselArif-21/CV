...
\maketitle
\section{Skills}
\cvline{Programming}{SQL/T-SQL, Python}
\cvline{Statistical}{Regression (Linear, Ridge, Lasso, Bayesian, Logistic, PCR), Clustering (K-Means), Markov Chain  Monte Carlo Simulations, Statistical Tests (Hypothesis Tests, Confidence Intervals, Prediction Intervals, Credible Intervals)}
...
\cventry{2019 -- Present}{Unilever - Data Science and Analytics Manager}{}{UK}{}{\normalsize
Responsibilities: 
\begin{itemize}
\item[-] Developing end-to-end Machine Learning solutions from a HR perspective.
\item[-] Ensuring the members of the team have support, guidance and direction.
\item[-] Leading, from a Data Science Point of View, the integration of third party Machine Learning solutions to recruitment.
\item[-] Training and up-skilling the team in areas such as SQL and Git.
\item[-] Introducing and maintaining source control within the team.
\end{itemize}}
...
\section{Training}
\cvline{December 2019}{\textbf{Machine Learning} - Machine Learning in Python. [\href{https://www.coursera.org/account/accomplishments/certificate/VWK8ULNA68UN}{Coursera-Certificate}]}
\cvline{December 2018}{\textbf{Bayesian Statistics} - Bayesian Statistics with R. [\href{https://www.coursera.org/account/accomplishments/verify/7HD9KTN289JK}{Coursera-Certificate}]}
