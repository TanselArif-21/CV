...
Responsibilities: 
\begin{itemize}
\item[-] Finding and carrying out optimisations and fixes to deal valuation methodologies.
\item[-] Implementing customisations to analytical software.
\item[-] Providing explanations for the calculations used in our in-house software.
\item[-] Acting as a conduit between the client, the development team and the theoretical material.
\item[-] Resolving any blocks in the progress of client requests.
\end{itemize}}
