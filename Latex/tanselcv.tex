...
\cventry{2015 -- present}{FIS - Financial Consultant in Risk and Compliance}{}{UK}{}{\normalsize Previously SunGard Financial Systems. A vendor providing solutions to financial corporations in terms of risk and exposure management and financial regulatory compliance. My role mostly involves: 
\begin{itemize}
...
\section{Education}
\cventry{2011 - 2015}{PhD in Materials Sience and Engineering}{Imperial College London}{UK}{}{\normalsize Supervisor: Dr. R. Qin}
\cventry{2009 - 2010}{Masters in Mathematics (MSci First Class)}{Queen Mary University of London}{UK}{}{\normalsize Supervisor: Prof. P. Cameron}
\cventry{2006 - 2009}{Bachelor's degree in Mathematics (First Class)}{Queen Mary University of London}{UK}{}{}
{}
...
{}
%\cvitem{}{
%Modules: Quantum Field Theory, Advanced Quantum Field Theory, Symmetry and Particle Physics, Supersymmetry and Extra Dimensions, Solitons and Instantons, Research Review on Vortices in QFT.
%}\vspace{0.1in}
{}

%%% WORK AND RESEARCH
\section{Research Experience}
\cventry{2011 -- present}{Imperial College London}{}{UK}{}{\normalsize The main focus during the course of my PhD research has been on the development of theory and code for the phase-field modelling and simulation of microstructures found in steel~\hyperref[refbain]{[1,2]} as well as the formation of van der Waals fluids using the smoothed particle hydrodynamics method. Given my interest in the prediction of general evolutionary phenomena, I have collaborated on cellular automata treatment for solidification~\hyperref[refmeas]{[3]}. My final results involve the development of tools in order to combine the capabilities of multiple models to deal with situations involving fluid flow, solidification and solid state phase transformations.}
\cventry{2009 -- 2010}{Queen Mary University of London}{}{UK}{}{\normalsize I investigated the pure mathematical constructions of codes in coding theory. The work involved writing code and alternative proofs for some known codes.}

\section{Awards and Professional Training}
\cvline{August 2017}{Inferential Statistics - Inferential Statistics with R. [\href{http://www.coursera.org/account/accomplishments/verify/TF3UNZB67DGH}{Coursera-Certificate}]}
\cvline{December 2016}{Front-End Web UI Frameworks and Tools - Bootstrap and Web Development. [\href{https://www.coursera.org/account/accomplishments/verify/BZVL5HSQNM3P}{Coursera-Certificate}]}
\cvline{August 2016}{Valuation: Alternative Methods - Financial Valuation. [\href{https://www.coursera.org/account/accomplishments/verify/EDJA367YEEJ5}{Coursera-Certificate}]}
...
\section{Talks, Posters \& Seminars}
...
\cvline{}{Bouldering, Advanced calisthenics (work in progress), Boxing, Football}
